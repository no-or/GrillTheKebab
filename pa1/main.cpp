...
cout << k->addIngredient('m') << endl; // k[0]
cout << k->addIngredient('z') << endl; // not valid ingredient
cout << k->addIngredient('B') << endl; // k[1]
cout << k->addIngredient('s') << endl; // k[2]
cout << k->addIngredient('p') << endl; // k[3]
cout << k->addIngredient('m') << endl; // k[4]
cout << k->addIngredient('t') << endl; // k[5]
cout << k->addIngredient('B') << endl; // k[6]
cout << k->addIngredient('m') << endl; // k[7]
cout << k->addIngredient('B') << endl; // > maxlength

cout << k->numMeats() << endl; // 3

Kebab* k2 = new Kebab();
k2->buildKebab("mmmbPstb");
//cout << k->hasSameIngredients(*k2) << endl; // true

Kebab* k3 = new Kebab();
k3->buildKebab("mmmbPsts");
//cout << k->hasSameIngredients(*k3) << endl; // false

//cout << k->listIngredients() << endl; // "mBspmtBm"

//Tests for LinkedList
LinkedList* ll = new LinkedList();
//cout << "The list is :" << endl;
//cout <<  ll->isEmpty() << endl; // true

Kebab* k4 = new Kebab();
k4->buildKebab("mmmPstp");

Kebab* k5 = new Kebab();
k5->buildKebab("mmPstpp");

//ll->insertAt(k4);
//cout << "The list is :" << endl;
//cout <<  ll->isEmpty() << endl; //false(0) 
...
//cout << "The list is :" << endl;
//cout << ll->isEmpty() << endl; // false

//cout << ll->size() << endl; // 5

cout << ll->contains(*k4) << endl; // true
cout << ll->contains(*k3) << endl; // truei
cout << ll->contains(*k2) << endl;
ll-> removeAt(3);
ll-> removeAt(2);
cout << ll->contains(*k4) << endl; // true
cout << ll->contains(*k5) << endl; // true
//Kebab check = *(ll)->elementAt(2);
//cout << "The element at 3 is :" << endl;
//cout << check.listIngredients() << endl; // k4 (?)


//Kebab check1 = *(ll)->elementAt(1);
//cout << "The element at 1 is :" << endl;
//cout << check1.listIngredients() << endl; // k4 (?)


//cout << ll->removeAt(2) << endl;
cout << ll->size() << endl; // 4
//cout << ll->elementAt(4) << endl; // NULL
*/
}
